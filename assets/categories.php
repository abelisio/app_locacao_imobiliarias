  ...
  <main class="content">
    ...
    <table class="data-grid">
      ...
      <tr class="data-row">
           ...
           <div class="data-grid-cell-content"><?=$rst['nome_categoria']?></div>

              </td>
      
        <td class="data-grid-td">
            <div class="data-grid-cell-content"><?=$rst['codigo_categoria']?></div>
        ...
        <td class="data-grid-td">
          <div class="actions">
            <div class="action edit" >
              <a  href="editCategory.php?id=<?= $rst['id'] ?>" </a> </div>
            <span>Edit</span>

            <div class="action delete"></div>
              <a href="deleteCategory.php?dir=db&amp;file=excluir_2&amp;excluir=<?= $rst['id'] ?>" </a>
              <span>Delete</span>
          </div>
        </td>
